...
package net.trueog.afkplusog.playerdata;
...
import net.trueog.afkplusog.api.AFKActionEvent;
import net.trueog.afkplusog.api.AFKStartEvent;
import net.trueog.afkplusog.api.AFKStopEvent;
import net.trueog.afkplusog.util.EssentialsAFKHook;
