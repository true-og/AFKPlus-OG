...
public class AFKPlusCmd extends AFKPlusCommand {
	...
	protected void onCommand(CommandSender sender, String[] args) {
		...
		if (args.length == 0) {
			...
			sender.sendMessage(primary + "Version: " + secondary + plugin.getPluginMeta().getVersion());
			sender.sendMessage(primary + "Author: " + secondary + plugin.getPluginMeta().getAuthors().get(0));
